...
public class CsrFactorizationBenchmark
{
    [ParamsSource(nameof(TestMatrices))]
    public SparseMatrixCsr matrix { get; set; }
    
    [Benchmark]
    public void CsrLuFactorization() => matrix.LuFactorize();

    [Benchmark(Baseline = true)]
    public void CsrLuFactorizationMarkowitz() => matrix.LuFactorizeMarkowitz();

    public IEnumerable<SparseMatrixCsr> TestMatrices => new[]
    {
